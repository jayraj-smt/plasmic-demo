...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: mYEwzWBGQ0ut/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__mVTcC
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker__mVTcC__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__bdskA
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker__bdskA__datePickerPopup"],
                  showTime: false
                };
