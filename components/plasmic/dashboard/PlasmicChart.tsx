...
import sty from './PlasmicChart.module.css' // plasmic-import: 4hRg0n9Hoplj/css
...
function PlasmicChart__RenderFunc(props: {
  ...
  const data = [
    ...
    { label: 'About', value: 72 },
    { label: 'Contact', value: 45 },
    { label: 'Blog', value: 123 },
  ]
  ...
  return (
    ...
    >
      ...
      <SimpleChart
        ...
        labelField={'label'}
        valueField={'value'}
        fill={true} // or remove if unnecessary
        interactive={true} // or remove if unnecessary
        type={'bar'}
        title={'Page Views'}
      />
    </Stack__>
