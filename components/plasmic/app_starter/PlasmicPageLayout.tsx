...
// Plasmic Project: cXGuvi8jtvYuaePaEHrW2z
// Component: R17R0cexuIfL
...
import projectcss from "./plasmic.module.css"; // plasmic-import: cXGuvi8jtvYuaePaEHrW2z/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: R17R0cexuIfL/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: LYo0AToDkn2h/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: FLcbBsaGjZTX/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__rvi8J)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__vbjZd)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__ongD5)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__qysd5)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___4TgCm)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
